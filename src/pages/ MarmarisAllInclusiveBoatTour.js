    ...
    <div>
      <Container className="page">
        ...
        <Row className="mt-3">
          <Col xs="12" md="8" lg="8">
            <p>
              Akdeniz ve Ege’nin birleştiği eşsiz güzellikteki koylarda denizin ve güneşin tadını çıkarırken mavinin
              tonlarından büyüleyici bir güne hazır olun. Marmaris tekne turunda eğlenceyi ve tertemiz sularda yüzerek
              denizin tadını çıkartın.
            </p>
            <br />
            <p>
              Marmaris’in büyüleyici masmavi koylarını teknemizle keşfetmeye hazır mısınız? Gün boyu sınırsız
              içeceklerin ve öğle yemeğinin dahil olduğu turumuzda ayrıca sizi servislerimiz ile otelinizden de
              alıyoruz. Teknemiz 2 katlı olup, üst katımızda herkes için şezlonglar bulunmaktadır. Güneş, deniz ve
              eğlenceyi birleştiren bu turumuz size unutulmaz bir gün yaşatacaktır.
            </p>
            <br />
            <List items={[
...
const TourProgram = () => {
  return (
    <p>
      Marmaris Günübirlik Tekne Turu Rotamız; Cennet Adasında fotoğraf molası , Akvaryum Koyunda yüzme molamız, Fosforlu
      Mağarada fotoğraf molası , Amos&Kumlubük’te yüzme molası, Turunç’ta iskeleye yanaşarak yüzme molası ve Turunç’u
      gezme şansı ve sahilden denize girme imkanı, Yeşil Deniz ise son yüzme molamızdır. Yüzme molalarımız 30 ile 45 er
...
const IncludedInTheFee = () => {
  return (
    <p>
      Ücretsiz otel transferi - Öğle Yemeği – Limitsiz çay,kahve,su - Limitsiz kola,fanta,sprite - Türkçe rehberlik
      hizmeti - Tüm sigortalar
    </p>
  );
};
